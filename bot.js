...
class cEmp {
	...
	heal(points, amount) { // Heal the points of employee by amount, calculated to include buffs and return the real amount of points healed
		if (["hp", "sp"].includes(points.toLowerCase()) === false || /\D/.test(amount)) {console.log(points + " " + amount);return undefined}// If the points aren't HP or SP, or if the amount has any characters besides digits in it, abandon ship
